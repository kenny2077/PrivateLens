...
- 181 passing tests plus lint, typing, bytecode, lock, and diff checks;
...
Hosted CI, PyPI/GHCR publication, Linux amd64, and the full Compose/Ollama flow
remain pending. CUDA and the desktop application are unsupported and are not
shipped in 1.0.
